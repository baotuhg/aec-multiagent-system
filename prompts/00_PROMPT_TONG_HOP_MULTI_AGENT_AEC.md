...
3. `aec_cost_engineer`: Kỹ sư Trưởng Dự toán BoQ (Lập bảng tính G_XD theo Thông tư 11, 12, 13/2021/TT-BXD bằng 100% công thức động Dài x Rộng x Cao x Số lượng x Hệ số).
4. `aec_lead_scheduler`: Kỹ sư Trưởng Tiến độ Thi công (Tra định mức ngày công TT 12/2021, tính thời gian thi công, xác định đường găng Critical Path CPM, xuất file Microsoft Project .xml / .mpp).
5. `aec_qaqc_engineer`: Kỹ sư Quản lý Chất lượng KCS (Lập danh mục 18 - 25 biên bản nghiệm thu chuyển bước theo Luật XD 135/2025/QH15 & NĐ 207/2026/NĐ-CP, trỏ công thức khối lượng từ QS sang KCS).
6. `aec_rebar_engineer`: Kỹ sư Cốt thép Tối ưu (Giải bài toán 1D Cutting Stock trên cây thép nguyên 11.7m, khống chế đề-xê vụn thừa < 1.5%, tính số cây nguyên xuất xưởng).
7. `aec_site_inspector`: Kỹ sư Giám sát Hiện trường & HSE (Mô hình YOLOv11 soi ảnh hiện trường: kiểm tra an toàn PPE mũ áo dây an toàn và phát hiện vết nứt bê tông, rỗ tổ ong).
...
* BƯỚC 3 (aec_cost_engineer):
  - Tiếp nhận dữ liệu từ aec_vision_takeoff và aec_rebar_engineer.
...
* BƯỚC 5 (aec_qaqc_engineer & aec_site_inspector):
...
1. Tệp EXCEL (.xlsx) liên kết động 100% bằng công thức sống (Tùy loại hình gồm 6 đến 8 sheet chuyên biệt).
